 ...
 */
public class GPUImageGeometryFilter extends MyGPUImageFilter{
    ...
    public void onInit() {
        ...
        if (mUsingStarTextureId == OpenGlUtils.NO_TEXTURE) {
            Bitmap bitmap1= BitmapFactory.decodeResource(MyApplication.getResource(), R.raw.geometry1);
            Bitmap bitmap2= BitmapFactory.decodeResource(MyApplication.getResource(), R.raw.geometry2);
            Bitmap bitmap3= BitmapFactory.decodeResource(MyApplication.getResource(), R.raw.geometry3);
            Bitmap bitmap4= BitmapFactory.decodeResource(MyApplication.getResource(), R.raw.geometry4);
